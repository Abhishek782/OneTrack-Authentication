...
class _UpDietState extends State<UpDiet> {
  ...
  Widget build(BuildContext context) {
    ...
    _buildFoodItem('methhi', 'Fenugreek', 000.00,0.00,"A"),
    _buildFoodItem('ice', 'Kulfi/Ice Cream', 267.00,0.00,"B,A,C"),
    _buildFoodItem('panip', 'Pani puri', 000.00,0.00,"AD"),
    _buildFoodItem('samosa', 'Samosa', 262.00,0.00,"A"),
    _buildFoodItem('pizza', 'Pizza', 270.00,0.00,"AD"),
    ...
    _buildFoodItem('pulses', 'Pulses', 70.00,0.00,"AD"),
    _buildFoodItem('pavbhaji', 'Pav-bhaji', 000.00,0.00,"AD"),
    ],
    ),
    ),
    ],
